       ...
       <> <div class="w-full" style={{zIndex:10}}>
            ...
            <div class="fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200  dark:bg-[#1e293b] dark:border-gray-600">
                ...
                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8v10a1 1 0 0 0 1 1h4v-5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v5h4a1 1 0 0 0 1-1V8M1 10l9-9 9 9"/>
                  ...
                  <img className="mb-2" width={active===1 ? 26 : 23} src="/images/home.png" />
             ...
             <img className="mb-2" width={active===2 ? 26 : 23} src="/images/possibilities.png" />
                    ...
                    <button onClick={()=>{router.push('/setting', { scroll: false })}} type="button" class={active === 3 ? buttonActive : buttonNoActive}>
                        {/* <svg class={active === 3 ? svgActive : svgNoActive} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                          ...
                          <img className="mb-2" width={active===3 ? 26 : 23} src="/images/setting.png" />
            ...
            <img className="mb-2" width={active===4 ? 26 : 23} src="/images/report.png" />
