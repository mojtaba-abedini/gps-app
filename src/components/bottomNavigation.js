       ...
       <> <div className="w-full" style={{zIndex:10}}>
            ...
            <div className="fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200  dark:bg-[#1e293b] dark:border-gray-600">
                <div className="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
                    ...
                    <svg className={active === 1 ? svgActive : svgNoActive} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8v10a1 1 0 0 0 1 1h4v-5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v5h4a1 1 0 0 0 1-1V8M1 10l9-9 9 9"/>
                    ...
                    <button onClick={()=>{router.push('/possibilities', { scroll: false })}} type="button" className={active === 2 ? buttonActive : buttonNoActive}>
                    <svg className={active === 2 ? svgActive : svgNoActive} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 18">
                <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6.143 1H1.857A.857.857 0 0 0 1 1.857v4.286c0 .473.384.857.857.857h4.286A.857.857 0 0 0 7 6.143V1.857A.857.857 0 0 0 6.143 1Zm10 0h-4.286a.857.857 0 0 0-.857.857v4.286c0 .473.384.857.857.857h4.286A.857.857 0 0 0 17 6.143V1.857A.857.857 0 0 0 16.143 1Zm-10 10H1.857a.857.857 0 0 0-.857.857v4.286c0 .473.384.857.857.857h4.286A.857.857 0 0 0 7 16.143v-4.286A.857.857 0 0 0 6.143 11Zm10 0h-4.286a.857.857 0 0 0-.857.857v4.286c0 .473.384.857.857.857h4.286a.857.857 0 0 0 .857-.857v-4.286a.857.857 0 0 0-.857-.857Z"/>
                    ...
                    <button onClick={()=>{router.push('/setting', { scroll: false })}} type="button" className={active === 3 ? buttonActive : buttonNoActive}>
                        <svg className={active === 3 ? svgActive : svgNoActive} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                            <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 12.25V1m0 11.25a2.25 2.25 0 0 0 0 4.5m0-4.5a2.25 2.25 0 0 1 0 4.5M4 19v-2.25m6-13.5V1m0 2.25a2.25 2.25 0 0 0 0 4.5m0-4.5a2.25 2.25 0 0 1 0 4.5M10 19V7.75m6 4.5V1m0 11.25a2.25 2.25 0 1 0 0 4.5 2.25 2.25 0 0 0 0-4.5ZM16 19v-2"/>
                        </svg>
                        <span className={active === 3 ? textActive : textNoActive}>تنظمیات</span>
                    </button>
                    <button onClick={()=>{router.push('/reports', { scroll: false })}}  type="button" className={active === 4 ? buttonActive : buttonNoActive}>
                    <svg className={active === 4 ? svgActive : svgNoActive} aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 16">
...
//             </button>
//             <div id="tooltip-microphone" role="tooltip" className="absolute z-40 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
//                 Mute microphone
...
//             </button>
//             <div id="tooltip-camera" role="tooltip" className="absolute z-40 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
//                 Hide camera
//                 <div className="tooltip-arrow" data-popper-arrow></div>
//             </div>
...
//             </button>
//             <div id="tooltip-feedback" role="tooltip" className="absolute z-40 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
//                 Share feedback
//                 <div className="tooltip-arrow" data-popper-arrow></div>
//             </div>
...
//             </button>
//             <div id="tooltip-settings" role="tooltip" className="absolute z-40 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
//                 Video settings
//                 <div className="tooltip-arrow" data-popper-arrow></div>
//             </div>
...
//             </button>
//             <div id="moreOptionsDropdown" className="z-40 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
...
//             </button>
//             <div id="tooltip-participants" role="tooltip" className="absolute z-40 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
//                 Show participants
//                 <div className="tooltip-arrow" data-popper-arrow></div>
//             </div>
...
//             </button>
//             <div id="tooltip-volume" role="tooltip" className="absolute z-40 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
//                 Adjust volume
//                 <div className="tooltip-arrow" data-popper-arrow></div>
//             </div>
...
//             </button>
//             <div id="tooltip-information" role="tooltip" className="absolute z-40 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
//                 Show information
//                 <div className="tooltip-arrow" data-popper-arrow></div>
//             </div>
//         </div>
